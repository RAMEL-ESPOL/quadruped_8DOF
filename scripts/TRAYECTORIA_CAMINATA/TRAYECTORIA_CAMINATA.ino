...
float target_angle  = 4.5;

float target_angle2  = -9.0;
...
if ( (i1==0) and (sensor.getSensorAngle() >= 4.5)  and (sensor.getSensorAngle() <= 4.55)) {
    //Actualiza el angulo al que desea estar
    //9.0
    i1=1;
    target_angle = 5.6;
...
if ( (i2==0) and (sensor2.getSensorAngle() <= -8.96)  and (sensor2.getSensorAngle() >= -9.00)) {
    //Actualiza el angulo al que desea estar
    //9.0
    i2=1;
    target_angle2 = -11.38;
...
if ( (i1==1) and (sensor.getSensorAngle() >= 5.6)  and (sensor.getSensorAngle() <= 5.66)) {
    //Actualiza el angulo al que desea estar
...
if ( (i2==1) and (sensor2.getSensorAngle() <= -11.38)  and (sensor2.getSensorAngle() >= -11.41)) {
    //Actualiza el angulo al que desea estar
    i2=2;
    target_angle2 = -11.39;
}

if ( (i1==2) and (sensor.getSensorAngle() >= 4.1)  and (sensor.getSensorAngle() <= 4.15)) {
    //Actualiza el angulo al que desea estar
    i1=3;
    target_angle = 6.0;
}

if ( (i2==2) and (sensor2.getSensorAngle() <= -11.39)  and (sensor2.getSensorAngle() >= -11.45)) {
    //Actualiza el angulo al que desea estar
    i2=3;
    target_angle2 = -13.6;
}
...
if ( (i1==3) and (sensor.getSensorAngle() >= 6.0)  and (sensor.getSensorAngle() <= 6.05)) {
    //Actualiza el angulo al que desea estar
    i1=0;
    target_angle = 4.5;
}

if ( (i2==3) and (sensor2.getSensorAngle() <= -13.6)  and (sensor2.getSensorAngle() >= -13.65)) {
    //Actualiza el angulo al que desea estar
    i2=0;
    target_angle2 = -8.96;
}
